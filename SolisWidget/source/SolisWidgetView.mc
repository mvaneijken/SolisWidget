    ...
    function makeReq() {
        ...
        if(uid == null || uid == -1){
            ...
            if(usr == null || usr.length() == 0 || pwrd == null || pwrd.length() == 0 ){
                ...
                WatchUi.requestUpdate();
                var url as String =  baseUrl+"/v/ap.2.0/cust/user/login?user_id=" + usr + "&user_pass=" + pwrd + "&terminate=android&push_sn=9601b3865bdabf6ea01a7318ac5cc749&timezone=1&lan=en&country=CN&cust=659";
